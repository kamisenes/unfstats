...
import com.unfollowerapp.unfollowerstats.jsonschema_unfollowers.ApiInterface_getidont_withp;
...
public class I_Dont_Follow_Back extends Fragment {
    ...
    private RecyclerView mRecyclerView;
        ...
        private ApiInterface_getidont_withp apiface;

        private List<Datum> d_l;
        public I_Dont_Follow_Back(Context c ){
        this.context=c;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.i_dont_follow_back,null);
        Objects.requireNonNull(getActivity()).setTitle("I-Dont-Follow-Back");
        d_list=new ArrayList<>();
        apiface=ApiClient_aboutme.getClient().create(ApiInterface_getidont_withp.class);


            try {

                mRecyclerView = (RecyclerView) view.findViewById(R.id.rc_i_dont_followback);
            ...
            public void onResponse(Call<data_Unfollowers> call, Response<data_Unfollowers> response) {
                if (response.code()==200){
                    ...
                    if (du.getDataCount()==0){
                        setDialog("There is no I-Dont-Follow-Back yet, please check later");
                    }else
                        {
                        resultAction(du);
                    }
